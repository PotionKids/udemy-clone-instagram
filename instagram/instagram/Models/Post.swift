...
struct Posts {
    ...
    static let rockPost2 = Post(image: "TR Post 2", description: """
    ...
    static let rockPost3 = Post(image: "TR Post 3", description: """
    ...
    static let obamaPost1 = Post(image: "BO Post 1", description: """
    ...
    static let obamaPost2 = Post(image: "BO Post 2", description: """
    ...
    static let obamaPost3 = Post(image: "BO Post 3", description: """
    ...
    static let obamaPost4 = Post(image: "BO Post 4", description: """
                                    Michelle and I grieve with the families in Uvalde, who are experiencing pain no one should have to bear.
                                    """)
    
    static let kevinHartPost1 = Post(image: "KH Post 1", description: """
    ...
    static let kevinHartPost2 = Post(image: "KH Post 2", description: """
    ...
    static let kevinHartPost3 = Post(image: "KH Post 3", description: """
    ...
    static let blakeLivelyPost1 = Post(image: "BL Post 1", description: """
                                    ...
                                    """)
    static let blakeLivelyPost2 = Post(image: "BL Post 2", description: """
                                    ...
                                    """)
    static let blakeLivelyPost3 = Post(image: "BL Post 3", description: """
    ...
    static let sushmitaSen1 = Post(image: "SS Post 1", description: """
                                    Up close & personal 😉❤️
                                    ...
                                    """)
    static let sushmitaSen2 = Post(image: "SS Post 2", description: """
                                    I love you guys!!!! #beyond ❤️🎶
                                    Here’s wishing you a stunning #wednesday 😉😄🌈 #duggadugga
                                    """)
    static let sushmitaSen3 = Post(image: "SS Post 3", description: """
